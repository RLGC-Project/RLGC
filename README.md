...
### Training
First launch java server which is used to simulate the power grid system. Then launch your training in the virtual environment. We provide two kinds of power grid system. ```RLGCJavaServer0.70.jar``` is the complex one and ```RLGCJavaServerSimple.jar```is the simple system.   
