...
class PowerDynSimEnv(gym.Env):
    ...
    def _reset(self):
        ...
        #candidates = [1, 3, 4, 14, 20, 24, 26]
        #candidates = [3, 14]  # 3 + 14
        #fault_bus_idx = candidates[np.random.randint(0, len(candidates))] # an integer, in the range of [0, total_bus_num-1]
        ...
        fault_start_time = 0.05 # a double number, in the range of [0.2, 1]
        #0.8 1.0
        #fault_duation_time = random.uniform(0.05, 0.10)  # a double number, in the range of [0.08, 0.4]
        fault_duation_time = 0.08 # a double number, in the range of [0.08, 0.4]
